...
class ChargingProfile(Object, additionalProperties=False):
...
class RemoteStartTransactionRequest(Object, additionalProperties=False):

    connectorId: Maybe[int] = Property(Integer())

    idTag: str = Property(String(maxLength=20), required=True)

    chargingProfile: Maybe[ChargingProfile] = Property(ChargingProfile)
