...
class ChangeAvailabilityResponse(Object, additionalProperties=False):
    ...
    status: str = Property(String(enum=['Accepted', 'Rejected', 'Scheduled'], description='This indicates whether the Charging Station is able to perform the availability change.\r\n'), required=True)
