...
class GetMonitoringReportResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'NotSupported', 'EmptyResultSet'], description='This field indicates whether the Charging Station was able to accept the request.\r\n'), required=True)
