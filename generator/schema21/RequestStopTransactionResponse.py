...
class RequestStopTransactionResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected'], description='Status indicating whether Charging Station accepts the request to stop a transaction.\r\n'), required=True)
