...
class SetDERControlResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'NotSupported', 'NotFound'], description='Result of operation.\r\n\r\n'), required=True)

    statusInfo: Maybe[StatusInfoType] = Property(StatusInfoType)

    supersededIds: Maybe[List[str]] = Property(Array(String(maxLength=36), additionalItems=False, minItems=1, maxItems=24, description='List of controlIds that are superseded as a result of setting this control.\r\n'))
