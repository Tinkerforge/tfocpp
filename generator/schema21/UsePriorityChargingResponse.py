...
class UsePriorityChargingResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'NoProfile'], description='Result of the request.\r\n'), required=True)
