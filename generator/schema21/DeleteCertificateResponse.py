...
class DeleteCertificateResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Failed', 'NotFound'], description='Charging Station indicates if it can process the request.\r\n'), required=True)
