...
class SendLocalListResponse(Object, additionalProperties=False):
    ...
    status: str = Property(String(enum=['Accepted', 'Failed', 'VersionMismatch'], description='This indicates whether the Charging Station has successfully received and applied the update of the Local Authorization List.\r\n'), required=True)
