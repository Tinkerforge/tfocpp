...
class GetMonitoringReportRequest(Object, additionalProperties=False):
    ...
    monitoringCriteria: Maybe[List[str]] = Property(Array(String(enum=['ThresholdMonitoring', 'DeltaMonitoring', 'PeriodicMonitoring']), additionalItems=False, minItems=1, maxItems=3, description='This field contains criteria for components for which a monitoring report is requested\r\n'))
