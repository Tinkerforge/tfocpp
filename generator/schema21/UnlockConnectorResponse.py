...
class UnlockConnectorResponse(Object, additionalProperties=False):
    ...
    status: str = Property(String(enum=['Unlocked', 'UnlockFailed', 'OngoingAuthorizedTransaction', 'UnknownConnector'], description='This indicates whether the Charging Station has unlocked the connector.\r\n'), required=True)
