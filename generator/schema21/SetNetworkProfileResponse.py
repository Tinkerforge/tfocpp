...
class SetNetworkProfileResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'Failed'], description='Result of operation.\r\n'), required=True)
