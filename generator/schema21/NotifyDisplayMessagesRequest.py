...
class NotifyDisplayMessagesRequest(Object, additionalProperties=False):

    messageInfo: Maybe[List[MessageInfoType]] = Property(Array(MessageInfoType, additionalItems=False, minItems=1))

    requestId: int = Property(Integer(description='The id of the &lt;&lt;getdisplaymessagesrequest,GetDisplayMessagesRequest&gt;&gt; that requested this message.\r\n'), required=True)

    tbc: bool = Property(Boolean(default=False, description='"to be continued" indicator. Indicates whether another part of the report follows in an upcoming NotifyDisplayMessagesRequest message. Default value when omitted is false.\r\n'))
