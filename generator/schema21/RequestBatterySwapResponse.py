...
class RequestBatterySwapResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected'], description='Accepted or rejected the request.\r\n'), required=True)
