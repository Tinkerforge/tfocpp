...
class CertificateSignedResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected'], description='Returns whether certificate signing has been accepted, otherwise rejected.\r\n'), required=True)
