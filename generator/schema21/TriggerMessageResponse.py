...
class TriggerMessageResponse(Object, additionalProperties=False):
    ...
    status: str = Property(String(enum=['Accepted', 'Rejected', 'NotImplemented'], description='Indicates whether the Charging Station will send the requested notification or not.\r\n'), required=True)
