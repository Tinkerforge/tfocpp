...
class SetDisplayMessageResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'NotSupportedMessageFormat', 'Rejected', 'NotSupportedPriority', 'NotSupportedState', 'UnknownTransaction', 'LanguageNotSupported'], description='This indicates whether the Charging Station is able to display the message.\r\n'), required=True)
