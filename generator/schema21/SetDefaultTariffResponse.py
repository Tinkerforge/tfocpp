...
class SetDefaultTariffResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'TooManyElements', 'ConditionNotSupported', 'DuplicateTariffId']), required=True)
