...
class InstallCertificateResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'Failed'], description='Charging Station indicates if installation was successful.\r\n'), required=True)
