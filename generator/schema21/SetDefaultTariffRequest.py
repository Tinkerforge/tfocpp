...
class SetDefaultTariffRequest(Object, additionalProperties=False):

    evseId: int = Property(Integer(minimum=0.0, description='EVSE that tariff applies to. When _evseId_ = 0, then tarriff applies to all EVSEs.\r\n\r\n'), required=True)

    tariff: TariffType = Property(TariffType, required=True)
