...
class SetMonitoringLevelResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected'], description='Indicates whether the Charging Station was able to accept the request.\r\n'), required=True)
