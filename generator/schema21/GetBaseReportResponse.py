...
class GetBaseReportResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Rejected', 'NotSupported', 'EmptyResultSet'], description='This indicates whether the Charging Station is able to accept this request.\r\n'), required=True)
