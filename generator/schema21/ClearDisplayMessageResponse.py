...
class ClearDisplayMessageResponse(Object, additionalProperties=False):

    status: str = Property(String(enum=['Accepted', 'Unknown', 'Rejected'], description='Returns whether the Charging Station has been able to remove the message.\r\n'), required=True)
