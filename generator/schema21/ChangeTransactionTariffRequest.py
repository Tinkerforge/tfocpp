...
class ChangeTransactionTariffRequest(Object, additionalProperties=False):

    tariff: TariffType = Property(TariffType, required=True)

    transactionId: str = Property(String(maxLength=36, description='Transaction id for new tariff.\r\n'), required=True)
