...
void platform_select_connector() {
    printf("platform_select_connector not implemented yet!\n");
}
void platform_register_select_connector_callback(void *ctx, void(*cb)(int32_t, void *), void *user_data) {
    printf("platform_register_select_connector_callback not implemented yet!\n");
}

ConnectorState platform_get_connector_state(int32_t connectorId) {
    //printf("platform_get_connector_state not implemented yet!\n");
    return ConnectorState::NotConnected;
}
